...
ad_proc -private im_material_create_from_parameters {
	...
	regsub { } [string tolower $material_name] "_" material_nr
	...
	if {"" == $material_id || 0 == $material_id} {
		...
		select im_material__new (
			...
			:material_name, :material_nr, [im_material_type_translation], [im_material_status_active],
			:material_uom_id, 'Automatically generated by intranet-trans-invoices-moravia'
		)
	        "]
